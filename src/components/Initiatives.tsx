  ...
  return (
    <section id="initiatives" className="flex min-h-screen w-full flex-col justify-center items-center py-24 px-6 max-w-6xl mx-auto scroll-mt-10">
      <div className="pointer-events-auto">
        <div className="mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Current & Future Initiatives</h2>
          <p className="text-gray-400 max-w-2xl text-lg">A curated snapshot of our key programmes focused on bridging theoretical foundations with real-world quantum applications.</p>
        </div>
