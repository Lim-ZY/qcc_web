    ...
    <section id="people" className="flex min-h-screen w-full flex-col justify-center items-center py-24 px-6 max-w-6xl mx-auto scroll-mt-10">
      <div className="pointer-events-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Our People</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {people.map((person, i) => (
            <div key={i} className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 text-center backdrop-blur-sm">
