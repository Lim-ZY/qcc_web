...
export default function Contact() {
  return (
    <section id="contact" className="flex min-h-screen w-full flex-col justify-center items-center py-24 px-6 max-w-3xl mx-auto text-center scroll-mt-10">
      <SectionHeader
        title="Contact"
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 ">
        <Button variant="link" className="p-6 gap-2 bg-white text-black text-md md:text-xl hover:bg-gray-200 rounded-full tracking-tight pointer-events-auto" size="lg" asChild>
          <Link href={`mailto:nus.qcc@gmail.com`}>
            <MailIcon className="h-4 w-4" />
            Email: nus.qcc@gmail.com
          </Link>
        </Button>
